        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <router-link to="/dashboard">
                            <svg class="block h-9 w-auto text-indigo-600 dark:text-indigo-400" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <div v-if="contextStore.availableContexts.length > 1" class="h-6 w-px bg-gray-200 dark:bg-gray-700 mx-2"></div>
