    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        <div class="w-full sm:max-w-2xl mt-6 px-6 py-8 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <div class="space-y-4">
                ...
                <div v-if="authStore.requiresCompany === 'optional'" class="relative py-4">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-white dark:bg-gray-800 text-gray-500 uppercase tracking-widest text-xs">O selecciona una empresa</span>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="flex items-center gap-2">
                                ...
                                <span v-if="company.rol_empresa" class="px-2 py-0.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded uppercase tracking-wider border border-gray-200 dark:border-gray-600">
                                    {{ company.rol_empresa }}
                                </span>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                {{ company.pais.toUpperCase() }} -
                                {{ company.tipo_identificador.toUpperCase() }}:
            ...
            <div class="mt-8 text-center">
                ...
                <router-link to="/login" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white underline">
